...
// added later to canonical docs (updated_at, media, etc).
test("buildAliasDoc propagates updated_at + media + future top-level fields", function () {
  var canonical = {
    _schema_version: 1,
    _meta: { auto_generated: true, source: "components/src/checkbox/", do_not_edit: "x" },
    slug: "checkbox",
    component: "Checkbox",
    meta: { category: "form-input-selection" },
    updated_at: "2026-05-19T10:00:00+00:00",
    media: { preview: "components/dist/media/checkbox/preview.png" },
  ...
  assert.deepEqual(alias.media, canonical.media);
