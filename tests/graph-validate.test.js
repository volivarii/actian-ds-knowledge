...
var base = {
  nodes: [
    ...
    { id: "a11y:focus-keyboard", type: "a11y_criterion", title: "Focus & Keyboard" }
  ],
  edges: [
    { source: "component:button", target: "category:action", type: "in_category" },
    { source: "category:action", target: "a11y:focus-keyboard", type: "a11y_ref" }
  ]
};
...
test("analyze: detects a dangling edge (missing target)", function () {
  var g = { nodes: base.nodes, edges: base.edges.concat([{ source: "category:action", target: "a11y:ghost", type: "a11y_ref" }]) };
  var r = V.analyze(g);
...
test("analyze: reports a category with no a11y_ref (advisory, not dangling)", function () {
  var g = { nodes: base.nodes.concat([{ id: "category:icons", type: "category", title: "Icons" }]),
    edges: base.edges };
  var r = V.analyze(g);
