...
During the `src/`+`dist/` migration, generators write BOTH this directory AND the legacy `components/registries/`, `components/text-styles.md`, `components/effect-styles.md` paths. Plugin consumers and external readers can use either; legacy paths drop in Phase D. See `docs/superpowers/specs/2026-05-10-knowledge-repo-restructure-design.md` in the plugin repo (gitignored) for the migration plan.
