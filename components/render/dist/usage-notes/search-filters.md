...
- Item-type filter values use the singular form of the type name (`Dataset`, not `Datasets`), matching the attribute being filtered rather than the count of results returned. This holds across Studio and Explorer.
