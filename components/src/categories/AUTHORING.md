...
2. Open a PR to `foundations/src/<slug>.md` or `accessibility/src/<slug>.md` adding the new pattern/section (and add the slug to the domain's `_order.json`). The slug is then automatically derivable.
