...
>
> **Sources** (50 sections): component-scoped content lives in `components/src/{slug}/content.md`; global / cross-cutting topics live in `content/src/{bucket}/{slug}.md` (buckets: writing, patterns, product) with a few meta files at the `content/src/` root.
> **Section order:** `content/src/content-index.md` ("All sections" anchors)
> **Authoring guides:** `components/src/AUTHORING.md` (per-component) · `content/src/AUTHORING.md` (global)
