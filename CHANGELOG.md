...
### Changed
- **Breaking Figma sync (2026-07-16).** Component or variant changes the nightly sync classified as breaking; the PR body carries the per-component diff summary. ([#429](https://github.com/volivarii/actian-ds-knowledge/pull/429))
