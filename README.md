...
| Layer | Path | Status |
|---|---|---|
| Component registries | `components/registries/{fmkit,dskit,metakit}.json` | Phase 1.1 (this slice) |
| Component guidelines | `components/guidelines/*.json` | Phase 1.1 (this slice) |
| Component MDs (auto-generated) | `components/{fm-components,dskit-components,meta-kit/components}.md` | Phase 1.1 (this slice) |
| Foundations | `foundations/foundations.md` + `foundations/*.json` | Phase 1.2 (planned) |
| Tokens | `tokens/tokens.json` (DTCG) + `tokens/tokens.css` | Phase 1.3 (planned) |
| Content guidelines | `content/content.md` (Jeff fold-in) | Phase 1.3 (planned) |
| Accessibility | `accessibility/accessibility.md` | Phase 1.3 (planned) |
| App context | `app-context/app-context.json` | Phase 1.3 (planned) |
| FM↔DS map | `fm-to-ds-map/fm-to-ds-map.json` | Phase 1.3 (planned) |
