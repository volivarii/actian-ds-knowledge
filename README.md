...
| **Category defaults** (mixed) | `components/src/categories/<slug>.md` (Design system lead + Content lead; 6 files) + `components/src/categories/AUTHORING.md` | `components/dist/categories/<slug>-defaults.json` (6 derived; CI from MD) |
