...
| `.github/workflows/validate-schemas.yml` | PR event on relevant src/dist paths | Ajv validates `components/src/guidelines/*.json`, `components/src/categories/*.md` frontmatter, `paths-manifest.json`, `foundations/dist/**/*.json`. Inline reviewdog annotations on the PR Files-Changed view. |
