...
## Phase B dual-publish (transient — through Phase D, ~2026-05)

During the `src/`+`dist/` migration, the parser writes BOTH this directory AND the legacy `foundations/*.json` paths. Plugin consumers and external readers can use either; legacy paths drop in Phase D. See `docs/superpowers/specs/2026-05-10-knowledge-repo-restructure-design.md` in the plugin repo (gitignored) for the migration plan.
